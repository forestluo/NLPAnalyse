...
-- =============================================
-- Author:		<罗堃>
-- Create date: <2021年1月29日>
-- Description:	<加载短语解析规则>
-- =============================================

CREATE OR ALTER FUNCTION LoadPhraseRules
(
...
BEGIN
	...
	DECLARE SqlCursor CURSOR
		...
		FROM dbo.PhraseRule WHERE classification IN ('数词', '数量词', '短语', '句子')
	-- 打开游标
	OPEN SqlCursor;
	-- 取第一条记录
	FETCH NEXT FROM SqlCursor INTO @SqlRID, @SqlRule, @SqlAttribute, @SqlClassification;
