...
--	(SELECT * FROM OPENROWSET (BULK 'E:\SQLServerProjects\自然语言分析\RegCLRVB.dll', SINGLE_BLOB) AS [Data])))
--EXEC sp_add_trusted_assembly @hash

CREATE ASSEMBLY RegexFunction 
		FROM 'E:\SQLServerProjects\自然语言分析\RegCLRVB.dll'--Change this to the filename and path of your DLL
GO
